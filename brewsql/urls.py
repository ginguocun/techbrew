...
urlpatterns = [
    ...
    re_path(r'^brew_update/(?P<pk>\d+)/$', views_change.BrewUpdate.as_view(), name='brew_update'),
    # 酿造管理-糖化
    re_path(r'^add_brew_record/$', views_add.BrewMonitorCreate.as_view(), name='add_brewmonitor'),
    re_path(r'^change_brew_record/(?P<pk>\d+)/$', views_change.BrewMonitorUpdate.as_view(), name='change_brewmonitor'),
    # 酿造管理-发酵监控
    ...
    re_path(r'^ferment_monitor_delete/(?P<pk>\d+)/$', views_change.FermentMonitorDelete.as_view(),
            name='ferment_monitor_delete'),
    # 酿造管理-检验报告
    re_path(r'^add_report/$', views_add.ReportCreate.as_view(), name='add_report'),
    re_path(r'^report_update/(?P<pk>\d+)/$', views_change.ReportUpdate.as_view(), name='report_update'),
    # 发酵罐
    ...
    re_path(r'^tank_update/$', views_change.tank_update, name='tank_update'),
    # 员工管理
    ...
    re_path(r'^employee_update/(?P<pk>\d+)/$', views_change.EmployeeUpdate.as_view(), name='employee_update'),
    re_path(r'^employee_state_list/$', views_add.EmployeeStateCreate.as_view(), name='employee_state_list'),
    re_path(r'^employee_s_update/(?P<pk>\d+)/$', views_change.EmployeeStateUpdate.as_view(), name='employee_s_update'),
    # 客户等级管理
    re_path(r'^client_level_list/$', views_add.ClientLevelCreate.as_view(), name='client_level_list'),
    re_path(r'^client_level_update/(?P<pk>\d+)/$', views_change.ClientLevelUpdate.as_view(), name='client_level_update'),
    # 客户管理
    ...
    re_path(r'^client_update/(?P<pk>\d+)/$', views_change.ClientUpdate.as_view(), name='client_update'),
    # 供应商管理
    ...
    re_path(r'^supplier_update/(?P<pk>\d+)/$', views_change.SupplierUpdate.as_view(), name='supplier_update'),
    # 公司信息管理
    ...
    re_path(r'^company_update/(?P<pk>\d+)/$', views_change.CompanyUpdate.as_view(), name='company_update'),
    # 产品风格
    re_path(r'^product_style/$', views_add.ProductStyleCreateView.as_view(), name='product_style_create'),
    re_path(r'^product_style_update/(?P<pk>\d+)/$', views_change.ProductStyleUpdateView.as_view(),
    ...
    re_path(r'^product_update/(?P<pk>\d+)/$', views_change.ProductUpdate.as_view(), name='product_update'),
    # 产品包装管理
    ...
    re_path(r'^product_pack_update/(?P<pk>\d+)/$', views_change.ProductPackUpdate.as_view(), name='product_pack_update'),
    # 产品归类管理
    ...
    re_path(r'^product_category_update/(?P<pk>\d+)/$', views_change.ProductCategoryUpdate.as_view(),
    ...
    re_path(r'^product_name_update/(?P<pk>\d+)/$', views_change.ProductNameUpdate.as_view(),
    ...
    re_path(r'^pack_update/(?P<pk>\d+)/$', views_change.PackUpdate.as_view(), name='pack_update'),
    # 产品出库单号管理
    ...
    re_path(r'^sale_order_update/(?P<pk>\d+)/$', views_change.SaleOrderUpdate.as_view(), name='sale_order_update'),
    re_path(r'^order_state_update/(?P<pk>\d+)/$', views_change.SaleOrderStateUpdate.as_view(), name='order_state_update'),
    re_path(r'^sale_order_delete/(?P<pk>\d+)/$', views_change.delete_sale_order, name='sale_order_delete'),
    re_path(r'^sale_order_next/$', views_change.sale_order_next, name='sale_order_next'),
    re_path(r'^sale_order_good_deliver/$', views_change.sale_order_good_deliver, name='sale_order_good_deliver'),
    re_path(r'^sale_order_fee_receive/$', views_change.sale_order_fee_receive, name='sale_order_fee_receive'),
    ...
    re_path(r'^sale_update/(?P<pk>\d+)/$', views_change.SaleUpdate.as_view(), name='sale_update'),
    re_path(r'^sale_confirm/$', views_change.sale_confirm, name='sale_confirm'),
    re_path(r'^sale_delete/(?P<pk>\d+)/$', views_change.sale_delete, name='sale_delete'),
    re_path(r'^sale_pay/$', views_change.sale_pay, name='sale_pay'),
    # 原料管理
    ...
    re_path(r'^material_update/(?P<pk>\d+)/$', views_change.MaterialUpdate.as_view(), name='material_update'),
    # 原料批次管理
    ...
    re_path(r'^material_batch_update/(?P<pk>\d+)/$', views_change.MaterialBatchUpdate.as_view(),
    ...
    re_path(r'^material_in_update/(?P<pk>\d+)/$', views_change.MaterialInUpdate.as_view(), name='material_in_update'),
    re_path(r'^material_in_delete/(?P<pk>\d+)/$', views_change.MaterialInDelete.as_view(), name='material_in_delete'),
    # 原料出库管理
    ...
    re_path(r'^material_out_update/(?P<pk>\d+)/$', views_change.MaterialOutUpdate.as_view(), name='material_out_update'),
    re_path(r'^material_out_delete/(?P<pk>\d+)/$', views_change.MaterialOutDelete.as_view(), name='material_out_delete'),
    # 原料包装规格
    re_path(r'^material_pack_list/$', views_add.MaterialPackSizeUnitCreate.as_view(), name='material_pack_list'),
    re_path(r'^material_pack_update/(?P<pk>\d+)/$', views_change.MaterialPackUpdate.as_view(),
            name='material_pack_update'),
    # 仓库管理
    re_path(r'^warehouse_list/$', views_add.WarehouseCreate.as_view(), name='warehouse_list'),
    re_path(r'^warehouse_update/(?P<pk>\d+)/$', views_change.WarehouseUpdate.as_view(), name='warehouse_update'),
    # 公司类型管理
    ...
    re_path(r'^user_update/(?P<pk>\d+)/$', views_change.UserUpdate.as_view(), name='user_update'),
    re_path(r'^group_update/(?P<pk>\d+)/$', views_change.GroupUpdate.as_view(), name='group_update'),
